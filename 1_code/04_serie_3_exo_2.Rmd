...
Oui, c'est toujours possible de retirer une variable d'un modèle. Est-ce que c'est souhaitable? Probablement que oui, parce que comme le montrent les résultats du modèle complet, le paramètre relié à la profession dans le secteur public (`Prof4`) n'est pas significativement différent de zéro.

## Partie 4

Oui, c'est toujours possible de retirer l'ordonnée à l'origine d'un modèle. Est-ce que c'est souhaitable? Probablement que oui, parce que comme le montrent les résultats, le paramètre relié à l'ordonnée à l'origine n'est pas significativement différent de zéro.
